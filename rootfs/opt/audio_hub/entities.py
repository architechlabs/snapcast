...
class EntityManager:
    ...
    def publish_discovery(self) -> None:
        ...
        entities = [
            ...
            ("number", "latency_ms", {"name": "Latency", "state_topic": f"{base}/state", "value_template": "{{ value_json.config.audio.latency_ms }}", "command_topic": f"{base}/cmd/latency_ms", "min": 40, "max": 1000, "step": 10, "mode": "slider", "unit_of_measurement": "ms"}),
